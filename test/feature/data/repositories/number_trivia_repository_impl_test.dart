import 'package:clean_architecure_course/error/exception.dart';
...
import 'package:clean_architecure_course/feature/number_trival/data/models/number_trivia_model.dart';
    ...
    runTestsOffline(() {
      ...
      test(
        ...
        () async {
          // arrange
          when(() => mockLocalDataSource.getLastNumberTrivia())
              .thenThrow(CacheException(message: 'kkkk'));
          // act
          final result = await repository.getConcreteNumberTrivia(tNumber);
          // assert
          verifyZeroInteractions(mockRemoteDataSource);
    ...
    runTestsOnline(() {
      ...
      test(
        ...
        () async {
          // arrange
          when(() => mockRemoteDataSource.getRandomNumberTrivia())
              .thenThrow(ServerException(message: 'jjj'));
          // act
          final result = await repository.getRandomNumberTrivia();
          // assert
          verify(() => mockRemoteDataSource.getRandomNumberTrivia());
    ...
    runTestsOffline(() {
      ...
      test(
        ...
        () async {
          // arrange
          when(() => mockLocalDataSource.getLastNumberTrivia())
              .thenThrow(CacheException(message: 'dddd'));
          // act
          final result = await repository.getRandomNumberTrivia();
          // assert
          verifyZeroInteractions(mockRemoteDataSource);
